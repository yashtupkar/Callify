...
function SidebarItem({ icon: Icon, label, to, shortcut = null }) {
      ...
      <aside className="w-64 border-r border-border bg-card flex flex-col shrink-0">
        ...
        <div className="flex-1 overflow-y-auto py-2 flex flex-col gap-1 px-3">
          <div className="mt-4 mb-1">
            ...
            <SidebarItem icon={Users} label="Agents" to="/dashboard/agents" />
            <SidebarItem icon={PhoneCall} label="Phone Numbers" to="/dashboard/phone-numbers" />
          </div>
        </div>
